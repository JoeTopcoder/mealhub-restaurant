          ...
          {[
            {
              ...
              desc: 'Fill in your restaurant details, menu, and delivery settings. Takes about 5 minutes.',
            },
            {
              step: '02',
              icon: '✅',
              title: 'Get verified',
              desc: 'Our team reviews your application within 48 hours. We\'ll notify you by email once approved.',
            },
            {
              step: '03',
              icon: '🚀',
              title: 'Start receiving orders',
              desc: 'Toggle your restaurant open and watch orders come in. Manage everything from your dashboard.',
            },
      ...
      <section className="py-16 bg-gradient-to-br from-purple-50 to-violet-50">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <blockquote className="text-2xl font-bold text-gray-900 leading-snug mb-6">
            "Since joining MealHub, our monthly revenue has increased by 40%. The dashboard makes managing orders so much easier."
          </blockquote>
